...
class SyncCommandBus(CommandBus):
    ...
    def __init__(self, commands_map: Optional[Dict[Type[Command], Type[CommandHandler]]] = None):
    ...
    def add_handler(self, command: Type[Command], command_handler: Type[CommandHandler]):
